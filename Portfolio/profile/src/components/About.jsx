    ...
    <div className="bg-black text-white py-20 " id="about">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12 ">
          <img src={About1} className="w-72 h-80 object-cover mb-8 mb:mb-0" />
          <div className="flex-1">
            <p className="text-lg mb-8">
              I am a passionate mern-stack developer with a focus on building
              modern and responsive web applications. with a strong fondation in
              ...
              <div className="flex items-center">
                ...
                <div className="grow bg-gray-800  rounded-full h-2.5">
                  <div className="bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full transform transition-transform
                   duration-300 hover:scale-105 w-11/12"></div>
                </div>
              </div>
              <div className="flex items-center">
                <label htmlFor="HtmlandCss" className="w-2/12">
            ...
            <div className="mt-12 flex justify-between text-center cursor-pointer ">
              <div>
                <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-4xl">
                  Intern/1+
                </h3>
